module m_advection_corrector
contains
subroutine advection_corrector(tempout,tempS,tempin,u,v,w,tau,n)
   ...
   use m_advection_predictor_kernel
   use m_advection_corrector_kernel
...
!   use m_theta_profile_partials
   ...
   real, intent(inout) :: tempS  (n,0:nx+1,0:ny+1,0:nz+1)
   ...
   call advection_corrector_kernel&
#ifdef _CUDA
        &<<<dim3(bx,by,bz), dim3(tx,ty,tz)>>>&
#endif
        &(tempin, temps, tempout, u, v, w, weights, tau, n)
