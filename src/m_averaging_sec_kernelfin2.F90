module m_averaging_sec_kernelfin2
contains
#ifdef _CUDA
   attributes(global)&
#endif
   subroutine averaging_sec_kernelfin2(iave, uxave, vxave, wxave, uxave2, vxave2, wxave2, Tix, uini )
#ifdef _CUDA
   use cudafor
#endif
   use mod_dimensions, only : nx,ny
   implicit none
   integer, value   :: iave
   real,    value   :: uini
