...
open(10,file='infile.in',status='new')
   ...
   write(10,'(a)')' city2            ! experiment      : Cylinder, airfoil etc'
   ...
   write(10,'(a)')' 1    600.0       ! iablvisc height : Atmospheric boundary layer (0-none, 1-mechanical layer, 2-buoyancy scheme)'
   write(10,'(a)')'# Time stepping and outputs'
   write(10,'(a)')' 00000            ! nt0             : First timestep'
   write(10,'(a)')' 1000             ! nt1             : Final timestep'
   ...
   write(10,'(a)')' 22               ! kbnd            : 0-periodic, 11,12,21,22 no-slip bb(1), free-slip bb(2) for k=1 and k=nz'
   ...
   write(10,'(a)')' 0                ! nturbines       : Number of turbines'
